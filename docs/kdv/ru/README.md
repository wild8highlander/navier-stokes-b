...
The **Russian manuscript edition** of the kdv monograph — the full,
...
| File | Role |
|---|---|
| [`KdV_b_correction_Chapter16.docx`](KdV_b_correction_Chapter16.docx) | the current Russian edition — complete text with embedded illustrations and editorial formatting |
