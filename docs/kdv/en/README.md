# 📗 docs · kdv · English Edition

> **Navigation:** [`docs`](../../README.md) › [`kdv`](../README.md) › **`en`**

![License](https://img.shields.io/badge/License-IPL--RP--1.0-red?style=flat-square)

English Word manuscript of the KdV chapter (~7.3 MB), complete with figures — the editorial source of `KdV_b_correction_Chapter16_EN.pdf` in [`papers/kdv/`](../../../papers/kdv/README.md).

## 📂 Contents — What Lives Here

| File | Size | Description |
|---|---|---|
| [`KdV_b_correction_Chapter16.docx`](KdV_b_correction_Chapter16.docx) | 7.1 MB | English Word manuscript of KdV chapter 16 with figures (~7.3 MB) |
...
English Word manuscript of chapter 16 on the KdV equation (~7.3 MB).

---

<div align="center">

**[⬆ Back to top](#-docs--kdv--english-edition)** · 
