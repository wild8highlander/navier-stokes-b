# `docs/kdv/en/` — the English Edition of the kdv Monograph

> **Navigation:** [`docs`](../../README.md) › [`kdv/`](../README.md) › **`en`**
...
The **English manuscript edition** of the kdv monograph — the full,
...
| File | Role |
|---|---|
| [`KdV_b_correction_Chapter16.docx`](KdV_b_correction_Chapter16.docx) | the current English edition — complete text with embedded illustrations and editorial formatting |
| `KdV_b_correction_Chapter16_backup_before_exact_edition.docx` | the snapshot taken immediately before the exact-edition pass |
