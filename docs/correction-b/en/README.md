# `docs/correction-b/en/` — the English Edition of the correction-b Monograph
...
![Language](https://img.shields.io/badge/Language-English-1284BA?style=flat-square) ![License](https://img.shields.io/badge/License-IPL--RP--1.0-red?style=flat-square)

The **English manuscript edition** of the correction-b monograph — the full,
...
| File | Role |
|---|---|
| [`monograph_with_figures.docx`](monograph_with_figures.docx) | the current English edition — complete text with embedded illustrations and editorial formatting |
...
- the other language edition: [`ru/`](README.md) —
...
Navigation: [correction-b](../README.md) · [docs](../../README.md) · [papers](../../../papers/README.md) · [IPL-RP-1.0](../../../LICENSE.md)
