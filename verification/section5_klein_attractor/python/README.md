...
The Python port of Section 5: one file, pure stdlib, PASS/JSON in a fraction of a second; result — the attractor's invariant-measure behaviour and the bridge connecting its dynamics back to the Navier–Stokes setting.
