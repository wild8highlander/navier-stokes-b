...
Lean 4 port of Section 1: one file with the theorems/checks of the "Correction b" section; section context — in the identically named block; build and output — same as in the Lean 4 layer README.
