# Isabelle-HOL · Section 4 — KdV

> **Navigation:** [`verification`](../../../verification/README.md) › **`Section4_KdV`**

![Isabelle-HOL](https://img.shields.io/badge/Isabelle--HOL-2024-1284BA?style=flat-square) ![Section](https://img.shields.io/badge/Section-4-9558B2?style=flat-square) ![License](https://img.shields.io/badge/License-IPL--RP--1.0-red?style=flat-square)

The **Isabelle-HOL port of Section 4** — KdV — Soliton Interactions under the b-Correction. This folder is
...
peer language of the matrix, each in its own idiom: [Python](../../../verification/section4_kdv/README.md) · [Lean 4](../../../verification/lean4/ResearchPapersVerification/Section4_KdV/README.md) · [Coq/Rocq](../../../verification/coq/section4_kdv/README.md) · [Agda](../../../verification/agda/Section4_KdV/README.md) · [C++](../../../verification/cpp/section4_kdv/README.md) · [Rust](../../../verification/rust/section4_kdv/README.md) · [Haskell](../../../verification/haskell/Section4_KdV/README.md). Agreement
...
`JSON: {"section": 4, "language": "isabelle", "values": {…}, "all_passed": …}`
...
| File | Description |
|---|---|
| [`KdV.thy`](KdV.thy) | the section 4 port — KdV — Soliton Interactions under the b-Correction |
...
isabelle jedit -l HOL Section4_KdV/KdV.thy     # interactive
```
