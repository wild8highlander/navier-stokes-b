...
Isabelle-HOL port of Section 2: a single file with the theorems/checks of the "Preprint NSE" section; the section context is given in the Section Context block above; build and output follow the Isabelle-HOL layer README.
