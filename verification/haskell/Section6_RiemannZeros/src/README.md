...
> **Navigation:** [`verification`](../../../README.md) › [`haskell`](../../README.md) › [`Section6_RiemannZeros`](../README.md) › **`src`**
...
|---|---|---|
| [`Main.hs`](Main.hs) | 288 B | Section 6 Haskell source — the complete section verifier |
...
Source of the Section 6 Haskell binary (Main.hs); the PASS/JSON contract is the same as in all ports.
