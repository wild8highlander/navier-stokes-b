# Haskell · Section 6 — Riemann Zeros

> **Navigation:** [`verification`](../../../verification/README.md) › **`Section6_RiemannZeros`**

![Haskell](https://img.shields.io/badge/Haskell-GHC_9.4-5E5086?style=flat-square&logo=haskell&logoColor=white) ![Section](https://img.shields.io/badge/Section-6-9558B2?style=flat-square) ![License](https://img.shields.io/badge/License-IPL--RP--1.0-red?style=flat-square)

The **Haskell port of Section 6** — Riemann Zeros — the Hilbert–Pólya Programme. This folder is
...
`JSON: {"section": 6, "language": "haskell", "values": {…}, "all_passed": …}`
...
| File | Description |
|---|---|
| [`src/Main.hs`](src/Main.hs) | the section 6 port — Riemann Zeros — the Hilbert–Pólya Programme |
| [`Section6_RiemannZeros.cabal`](Section6_RiemannZeros.cabal) | the crate/package manifest |
...
cabal run section6-riemann-zeros               # this section
```
