# Coq/Rocq · Section 1 — Correction b

> **Navigation:** [`verification`](../../../verification/README.md) › **`section1_correction_b`**

![Coq/Rocq](https://img.shields.io/badge/Coq%2FRocq-8.18-DC8447?style=flat-square&logo=ocaml&logoColor=white) ![Section](https://img.shields.io/badge/Section-1-9558B2?style=flat-square) ![License](https://img.shields.io/badge/License-IPL--RP--1.0-red?style=flat-square)

The **Coq/Rocq port of Section 1** — Correction b — the Universal Polarization Constant. This folder is
...
peer language of the matrix, each in its own idiom: [Python](../../../verification/section1_correction_b/README.md) · [Lean 4](../../../verification/lean4/ResearchPapersVerification/Section1_CorrectionB/README.md) · [Isabelle-HOL](../../../verification/isabelle/Section1_CorrectionB/README.md) · [Agda](../../../verification/agda/Section1_CorrectionB/README.md) · [C++](../../../verification/cpp/section1_correction_b/README.md) · [Rust](../../../verification/rust/section1_correction_b/README.md) · [Haskell](../../../verification/haskell/Section1_CorrectionB/README.md). Agreement
...
`JSON: {"section": 1, "language": "coq", "values": {…}, "all_passed": …}`
...
| File | Description |
|---|---|
| [`CorrectionB.v`](CorrectionB.v) | the section 1 port — Correction b — the Universal Polarization Constant |

## ▶️ How to run

```bash
cd verification/coq
coqc section1_correction_b/CorrectionB.v                        # one file (prints Compute output)
