...
The Python port of Section 2: one file, pure stdlib, PASS/JSON in a fraction of a second; result — the stabilisation mechanism induced by θ_b ≈ 7.07° and the 3.5× reduction of the BKM blow-up criterion integral.
