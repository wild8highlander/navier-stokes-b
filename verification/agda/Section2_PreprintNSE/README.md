# Agda · Section 2 — Preprint NSE

> **Navigation:** [`verification`](../../../verification/README.md) › **`Section2_PreprintNSE`**

![Agda](https://img.shields.io/badge/Agda-2.6-CB6BA7?style=flat-square&logo=agda&logoColor=white) ![Section](https://img.shields.io/badge/Section-2-9558B2?style=flat-square) ![License](https://img.shields.io/badge/License-IPL--RP--1.0-red?style=flat-square)

The **Agda port of Section 2** — Preprint NSE — the Regularity Argument Chain. This folder is
...
peer language of the matrix, each in its own idiom: [Python](../../../verification/section2_preprint/README.md) · [Lean 4](../../../verification/lean4/ResearchPapersVerification/Section2_PreprintNSE/README.md) · [Coq/Rocq](../../../verification/coq/section2_preprint/README.md) · [Isabelle-HOL](../../../verification/isabelle/Section2_PreprintNSE/README.md) · [C++](../../../verification/cpp/section2_preprint/README.md) · [Rust](../../../verification/rust/section2_preprint/README.md) · [Haskell](../../../verification/haskell/Section2_PreprintNSE/README.md). Agreement
...
`JSON: {"section": 2, "language": "agda", "values": {…}, "all_passed": …}`
...
| File | Description |
|---|---|
| [`ProofChain.agda`](ProofChain.agda) | the section 2 port — Preprint NSE — the Regularity Argument Chain |

## ▶️ How to run

```bash
cd verification/agda
agda --safe Section2_PreprintNSE/ProofChain.agda                 # type-check this module
```
