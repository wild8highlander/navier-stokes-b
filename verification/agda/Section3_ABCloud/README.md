...
Agda port of Section 3: a single file with the theorems/checks of the “AB-Cloud” section; the section context is given in the block of the same name; build and output follow the Agda layer README.
