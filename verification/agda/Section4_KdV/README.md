...
![Agda](https://img.shields.io/badge/Agda-2.6-CB6BA7?style=flat-square&logo=agda&logoColor=white) ![Section](https://img.shields.io/badge/Section-4-9558B2?style=flat-square) ![License](https://img.shields.io/badge/License-IPL--RP--1.0-red?style=flat-square)

The **Agda port of Section 4** — KdV — Soliton Interactions under the b-Correction. This folder is
...
peer language of the matrix, each in its own idiom: [Python](../../../verification/section4_kdv/README.md) · [Lean 4](../../../verification/lean4/ResearchPapersVerification/Section4_KdV/README.md) · [Coq/Rocq](../../../verification/coq/section4_kdv/README.md) · [Isabelle-HOL](../../../verification/isabelle/Section4_KdV/README.md) · [C++](../../../verification/cpp/section4_kdv/README.md) · [Rust](../../../verification/rust/section4_kdv/README.md) · [Haskell](../../../verification/haskell/Section4_KdV/README.md). Agreement
...
`JSON: {"section": 4, "language": "agda", "values": {…}, "all_passed": …}`
...
| File | Description |
|---|---|
| [`KdV.agda`](KdV.agda) | the section 4 port — KdV — Soliton Interactions under the b-Correction |

## ▶️ How to run

```bash
cd verification/agda
agda --safe Section4_KdV/KdV.agda                 # type-check this module
```
