...
Agda port of Section 4: a single file with the theorems/checks of the “KdV” section; the section context is given in the block of the same name; build and output follow the Agda layer README.
