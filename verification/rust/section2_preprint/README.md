...
Rust port of Section 2: one file with the theorems/checks of the "Preprint NSE" section; section context — in the identically named block; build and output — same as in the Rust layer README.
