...
> **Navigation:** [`verification`](../../../README.md) › [`rust`](../../README.md) › [`section1_correction_b`](../README.md) › **`src`**
...
|---|---|---|
| [`main.rs`](main.rs) | 1000 B | Section 1 Haskell source — the complete section verifier |
...
Source code of the Section 1 Haskell binary (main.rs); the PASS/JSON contract is the same as in all ports.
