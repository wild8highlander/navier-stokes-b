# Rust · Section 5 — Klein Attractor

> **Navigation:** [`verification`](../../../verification/README.md) › **`section5_klein_attractor`**

![Rust](https://img.shields.io/badge/Rust-1.75%2B-DEA584?style=flat-square&logo=rust&logoColor=white) ![Section](https://img.shields.io/badge/Section-5-9558B2?style=flat-square) ![License](https://img.shields.io/badge/License-IPL--RP--1.0-red?style=flat-square)

The **Rust port of Section 5** — Klein Attractor — Ergodic Dynamics and the NSE Bridge. This folder is
...
`JSON: {"section": 5, "language": "rust", "values": {…}, "all_passed": …}`
...
| File | Description |
|---|---|
| [`src/main.rs`](src/main.rs) | the section 5 port — Klein Attractor — Ergodic Dynamics and the NSE Bridge |
...
cargo run --release -p section5_klein_attractor      # this section
