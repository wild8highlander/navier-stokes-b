...
Rust port of Section 5: one file with the theorems/checks of the "Klein Attractor" section; section context — in the identically named block; build and output — same as in the Rust layer README.
