...
> **Navigation:** [`verification`](../../../README.md) › [`rust`](../../README.md) › [`section3_ab_cloud`](../README.md) › **`src`**
...
|---|---|---|
| [`main.rs`](main.rs) | 961 B | Section 3 Haskell source — the complete section verifier |
...
Source code of the Section 3 Haskell binary (main.rs); the PASS/JSON contract is the same as in all ports.
