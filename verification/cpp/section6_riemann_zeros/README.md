# C++ · Section 6 — Riemann Zeros

> **Navigation:** [`verification`](../../../verification/README.md) › **`section6_riemann_zeros`**

![C++](https://img.shields.io/badge/C%2B%2B-17-00599C?style=flat-square&logo=cplusplus&logoColor=white) ![Section](https://img.shields.io/badge/Section-6-9558B2?style=flat-square) ![License](https://img.shields.io/badge/License-IPL--RP--1.0-red?style=flat-square)

The **C++ port of Section 6** — Riemann Zeros — the Hilbert–Pólya Programme. This folder is
...
`JSON: {"section": 6, "language": "cpp", "values": {…}, "all_passed": …}`
...
| File | Description |
|---|---|
| [`main.cpp`](main.cpp) | the section 6 port — Riemann Zeros — the Hilbert–Pólya Programme |
...
./build/section6_riemann_zeros                     # run this section's binary
```
