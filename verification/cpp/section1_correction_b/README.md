...
C++ port of Section 1: a single file with the theorems/checks of the “Correction b” section; the section context is given in the block of the same name; build and output follow the C++ layer README.
